...
export const glossRepulpant = {
  ...
  colors: {
    ...
    titleColorInSummary: "#008eac",
    bgColorInSummary0: "#4db0c5",
    bgColorInSummary1: "#e0f1f5",
    linearGradient0: "linear-gradient(105deg ,#4db0c5, #afe6ff)",
    linearGradient1: "linear-gradient(to right, #80c7d6, 	#e0f1f5)",
    shadowColor: "#e0f1f5"
  },
  inSummary: [
    {
      ...
      text: (
        <ul>
          <li>Repulpe instantanément les lèvres</li>
          <li>Lisse et adoucit</li>
          <li>Efface les rides des lèvres</li>
          <li>
            A long terme, les lèvres sont plus lisses, plus souples et plus
            volumineuses.
          </li>
          <li>Testé dermatologiquement</li>
          <li>A obtenu le label d’approbation « Good Face Project</li>
        </ul>
      )
    }
  ]
