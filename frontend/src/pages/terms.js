    ...
    <div className="overflowHidden">
      ...
      <main className="globalLegalContainer">
        ...
        <div className="legalContainer">
          ...
          <p>
            En accédant, naviguant ou utilisant un-possible.fr, vous
          ...
          <p>
            un-possible.fr se réserve le droit de mettre à jour ou de modifier
            ces conditions à tout moment et sans préavis. Il est de votre
          ...
          <p>
            un-possible.fr met tout en œuvre pour assurer un accès continu à son
            site, mais ne peut garantir l'absence d'interruptions ou d'erreurs.
            Nous nous réservons le droit de retirer, modifier ou améliorer tout
            contenu ou service fourni sur le site à notre seule discrétion et
            sans préavis.
          </p>
          <h2 className="subLegalTitle">Propriété intellectuelle</h2>
          <p>
            Tous les contenus présents sur un-possible.fr, y compris, mais sans
            s'y limiter, les textes, graphiques, logos, images, vidéos et
            marques de commerce, sont la propriété exclusive de Une Parenthèse
            pour Soi ou de ses partenaires. Toute reproduction, distribution ou
            utilisation de ces contenus sans l'autorisation écrite préalable de
            Une Parenthèse pour Soi est strictement interdite.
          </p>
          <h2 className="subLegalTitle">Marques de commerce</h2>
          <p>
            Les logos, noms et toutes les marques affichées sur le site sont des
            marques déposées ou non déposées appartenant à Un Possible ou à des
            tiers. Rien sur un-possible.fr ne devrait être interprété comme
            accordant, par implication, estoppel ou autrement, une licence ou un
            droit d'utiliser une marque affichée sur le site sans l'autorisation
            écrite de Un Possible ou du tiers propriétaire de la marque.
          </p>
          ...
          <p>
            ...
            des informations sur un-possible.fr, nous ne garantissons pas
            qu'elles soient toujours exactes, complètes ou à jour.
            un-possible.fr ne peut être tenu responsable de tout dommage direct,
            indirect, consécutif ou spécial résultant de l'utilisation ou de
            l'impossibilité d'utiliser le site.
          </p>
          <h2 className="subLegalTitle">Liens vers d'autres sites</h2>
          <p>
            un-possible.fr peut contenir des liens vers des sites tiers. Ces
            liens sont fournis uniquement pour la commodité de l'utilisateur.
            L'inclusion de tout lien n'implique pas une recommandation ou une
            approbation par un-possible.fr. Nous ne sommes pas responsables du
            contenu ou des pratiques de ces sites tiers.
          </p>
          <h2 className="subLegalTitle">Loi applicable</h2>
          <p>
            Les présentes conditions sont régies par la loi française. Tout
            litige relatif à un-possible.fr sera soumis à la juridiction
          ...
          <p>
            ...
            documents de un-possible.fr pour un usage personnel et non
            ...
            strictement interdite sans l'autorisation écrite préalable de Un
            Possible.{" "}
          </p>
          ...
          <p>
            Vous êtes autorisé à utiliser un-possible.fr uniquement à des fins
            légales et conformément aux présentes conditions. Il est strictement
            interdit de :{" "}
          </p>
          <ul>
            <li>
