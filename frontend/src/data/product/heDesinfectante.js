...
export const heDesinfectante = {
  ...
  colors: {
    ...
    bgColorInSummary0: "#0017a5",
    bgColorInSummary1: "#fbe4e6",
    linearGradient0: "linear-gradient(105deg, #de1c30, #fff3f3)",
    linearGradient1: "linear-gradient(to right, #ef8e98, #fbe4e6)",
    shadowColor: "#fbe4e6"
  },
  inSummary: [
    {
